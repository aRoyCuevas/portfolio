...
const i18n = {
    es: {
        ...
        exp2Bullet1: 'Lideré el desarrollo end-to-end de una aplicación de escritorio en Python para procesamiento local de PDFs, priorizando privacidad y funcionamiento offline.',
    ...
    en: {
        ...
        exp2Bullet1: 'Led end-to-end development of a Python desktop application for local PDF processing, prioritizing privacy and offline functionality.',
